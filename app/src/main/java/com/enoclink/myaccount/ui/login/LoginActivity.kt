...
import com.enoclink.myaccount.ui.profile.ProfileActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val email = findViewById<EditText>(R.id.txvEmail)
        val password = findViewById<EditText>(R.id.txvPassword)
